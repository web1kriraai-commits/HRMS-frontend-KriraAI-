...
import { formatDate, formatDuration, getTodayStr, convertToDDMMYYYY, convertToYYYYMMDD, calculateBondRemaining, parseDDMMYYYY, isPenaltyEffective, calculateLatenessPenaltySeconds, resolveLatePenaltyStartTime, formatPenaltyDisplay, getLateCheckInPenaltyInfo, bondsToFormEntries, buildBondsUpdatePayload, BondFormEntry } from '../services/utils';
...
export const HRDashboard: React.FC = () => {
  ...
  const handleCorrection = async (e: React.FormEvent) => {
    ...
    if (!correction.checkIn && !correction.checkOut) {
      appAlert("Please provide at least Check In or Check Out time");
      return;
    }
            ...
            <Card className="h-fit">
              ...
              <form onSubmit={async (e) => {
                ...
                if (!paidLeaveAllocation.userId) {
                  appAlert("Please select an employee");
                  return;
                }
                if (!paidLeaveAllocation.allocation || paidLeaveAllocation.allocation === '') {
                  appAlert("Please enter a number to add");
                  return;
                }
                try {
                  ...
                  appAlert(`Added ${allocation} paid leave(s) successfully.`);
                  setPaidLeaveAllocation({ userId: '', allocation: '' });
                  await refreshData();
                } catch (error: any) {
                  appAlert(error.message || "Failed to update paid leave allocation");
                }
              }} className="space-y-5">
                <div>
                ...
                <form onSubmit={handleCreateUser} className="space-y-8">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Define employment bonds with start/end dates</p>
                    </div>
